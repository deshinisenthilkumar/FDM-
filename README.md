...
# Code:
```
Fs = 60000;                 // Changed from 50000
t = 0:1/Fs:0.02;

// Message frequencies changed but still separated & < 1000 Hz
m1 = 1.5 * sin(2*%pi*260*t);
m2 = 1.3 * sin(2*%pi*360*t);
m3 = 1.7 * sin(2*%pi*460*t);
m4 = 1.9 * sin(2*%pi*560*t);
m5 = 2.1 * sin(2*%pi*660*t);
m6 = 2.3 * sin(2*%pi*760*t);

// Carrier frequencies changed but maintain same spacing
c1 = 5000;
c2 = 9000;
c3 = 13000;
c4 = 17000;
...
fc = 1200; // Changed but still above message frequencies
...
```
# Output Waveform
<img width="900" height="500" alt="image" src="https://github.com/user-attachments/assets/96d7451b-f303-4bc6-9835-8be08239b443" />

# Tabulation:
![WhatsApp Image 2025-11-23 at 11 02 31_fac55dc2](https://github.com/user-attachments/assets/96e532f5-3aca-4d79-8d29-ba4a65ee8313)
